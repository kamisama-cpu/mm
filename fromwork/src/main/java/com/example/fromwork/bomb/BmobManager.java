package com.example.fromwork.bomb;
...
public class BmobManager {
    ...
    private static final String BMOB_SDK_ID = "5d9766d04e0d3748bae1b749c47b1aa1";
            ...
            public void done(List<IMUser> list, BmobException e) {
                if (e == null) {
                    if (CommonUtils.isEmpty(list)) {
                        ...
                        addFriend(imUser, new SaveListener<String>() {
                            @Override
     ...
     * 上传图片
     */
    public void upLoadPicture(String name,File file){
        final IMUser imUser = getUser();
